...
const css$a = {
  code: ".fullscreen.svelte-1tf7m4c.svelte-1tf7m4c{position:fixed;top:0;left:0;width:100%;height:100%;display:flex;align-items:center;justify-content:center;background-color:rgba(0, 0, 0, 0.2);backdrop-filter:blur(2px);z-index:99;opacity:0;pointer-events:none;transition:opacity 0.3s ease}.open.svelte-1tf7m4c.svelte-1tf7m4c{opacity:1;pointer-events:auto}.modal-outer.svelte-1tf7m4c.svelte-1tf7m4c{position:relative;color:#fff;background-color:var(--bg);height:calc(100vh - 13rem);width:calc(100vw - 26em);margin-left:13rem;box-shadow:1px -2px 31px 2px rgba(0, 0, 0, 0.2);-webkit-box-shadow:1px -2px 31px 2px rgba(0, 0, 0, 0.2);-moz-box-shadow:1px -2px 31px 2px rgba(0, 0, 0, 0.2)}.close-button.svelte-1tf7m4c.svelte-1tf7m4c{position:absolute;left:5rem;bottom:3.5rem;background-color:transparent;padding:0}@media(max-width: 600px){.modal-outer.svelte-1tf7m4c.svelte-1tf7m4c{margin:5rem;height:calc(100dvh - 16rem);align-self:end;width:100%;margin:0}.modal-outer.svelte-1tf7m4c .close-button.svelte-1tf7m4c{left:53rem;bottom:5rem}}",
  map: null
};
const Modal = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${escape(null_to_empty(isOpen ? "fullscreen open" : "fullscreen"), true) + " svelte-1tf7m4c"}"><div class="modal-outer svelte-1tf7m4c">${slots.default ? slots.default({}) : ``}
    <button class="close-button svelte-1tf7m4c">${validate_component(Button, "Button").$$render($$result, { text: "Return" }, {}, {})}</button></div>
</div>`;
});
const ModalStyles = "";
  ...
  <div class="container-img svelte-fpkip3"><div><a href="http://sanlam-dsm.mlab.cx/ " target="_blank">${validate_component(ImageLoader, "ImageLoader").$$render(
    ...
    {}
      ...
      <span><a class="link svelte-fpkip3" href="http://sanlam-dsm.mlab.cx/ " target="_blank">http://sanlam-dsm.mlab.cx
        ...
        ${validate_component(Clipboard, "Clipboard").$$render($$result, { text: "q)gdLtP*gt8zpJKD" }, {}, {})}</span></div></div>
</section>`;
});
