...
const css = {
  code: ".main.svelte-t6cb2x.svelte-t6cb2x{display:flex;flex-direction:row;justify-content:start;align-items:start;margin-left:0;width:100%;background-color:var(--bg);z-index:1}.aside-back.svelte-t6cb2x.svelte-t6cb2x{width:16rem;z-index:98;background-color:var(--bg-alt);height:100vh}.container-text.svelte-t6cb2x.svelte-t6cb2x{position:relative;display:flex;flex-direction:column;width:45%;height:100vh;padding-right:6rem;padding-left:9rem;background-color:var(--bg);transform:translateY(0)}.container-text.svelte-t6cb2x div.svelte-t6cb2x{margin-top:-5rem}.fill_alt.svelte-t6cb2x.svelte-t6cb2x{position:absolute;bottom:0;right:0;height:2.5rem;width:100%;background-color:var(--bg);z-index:1}.tag-one.svelte-t6cb2x.svelte-t6cb2x{position:absolute;left:4.5rem;bottom:4rem}.tag-two.svelte-t6cb2x.svelte-t6cb2x{position:absolute;left:2.5rem;bottom:1rem}.container-map.svelte-t6cb2x.svelte-t6cb2x{position:relative;height:100%;width:55%;z-index:1}@media(max-width: 600px){.contact.svelte-t6cb2x.svelte-t6cb2x{flex-direction:column-reverse;overflow:hidden}.contact.svelte-t6cb2x .container-text.svelte-t6cb2x{width:80%;height:55%}.contact.svelte-t6cb2x .container-text .head_alt.svelte-t6cb2x{font-size:2.2rem}.contact.svelte-t6cb2x .container-map.svelte-t6cb2x{width:193vw;height:45%}.contact.svelte-t6cb2x .container-map .fill_alt.svelte-t6cb2x{position:absolute;bottom:-1.5rem;right:0;height:6.5rem;width:100%;background-color:var(--bg);z-index:1}}",
  map: null
};
const s = "8rem";
const sp = "-0.2rem";
const Contact = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<main id="Contact" class="main contact svelte-t6cb2x"><span class="aside-back svelte-t6cb2x"></span>
  <span class="container-text center-parent svelte-t6cb2x"><div class="svelte-t6cb2x"><p class="tag" style="margin: 0 0 -1.5rem -1rem;">&lt;h1&gt;</p>
      ...
      <span class="head_alt svelte-t6cb2x">I’m interested in working as a front-end developer, especially ambitious
    ...
    <p class="tag tag-two svelte-t6cb2x">&lt;/html&gt;</p>
    <p class="tag tag-one svelte-t6cb2x">&lt;/body&gt;</p></span>

  <div class="container-map svelte-t6cb2x"><iframe title="map" src="https://snazzymaps.com/embed/491438" width="100%" height="100%" style="border:none;"></iframe>
    <div class="fill_alt svelte-t6cb2x"></div></div>
</main>`;
});
export {
  Contact as C
