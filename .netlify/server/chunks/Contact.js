...
const css = {
  code: ".main.svelte-1lqqj55.svelte-1lqqj55{display:flex;flex-direction:row;margin-left:0;width:100%;background-color:var(--bg);z-index:1}.aside-back.svelte-1lqqj55.svelte-1lqqj55{width:16rem;height:100vh}.container-text.svelte-1lqqj55.svelte-1lqqj55{position:relative;display:flex;flex-direction:column;width:45%;height:100vh;padding-right:7.5rem;padding-left:7.5rem;background-color:var(--bg)}.container-text.svelte-1lqqj55 div.svelte-1lqqj55{margin-top:-5rem}.fill_alt.svelte-1lqqj55.svelte-1lqqj55{position:absolute;bottom:0;right:0;height:2.5rem;width:100%;background-color:var(--bg);z-index:1}.tag-one.svelte-1lqqj55.svelte-1lqqj55{position:absolute;left:4.5rem;bottom:4rem}.tag-two.svelte-1lqqj55.svelte-1lqqj55{position:absolute;left:2.5rem;bottom:1rem}.container-map.svelte-1lqqj55.svelte-1lqqj55{position:relative;height:100%;width:55%;z-index:1}",
  map: null
};
const s = "8rem";
const sp = "-0.2rem";
const Contact = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<main id="Contact" class="main contact svelte-1lqqj55"><span class="aside-back svelte-1lqqj55"></span>
  <span class="container-text center-parent svelte-1lqqj55"><div class="svelte-1lqqj55"><p class="tag" style="margin: 0 0 -1.5rem -1rem;">&lt;h1&gt;</p>
    ...
    <p class="tag tag-two svelte-1lqqj55">&lt;/html&gt;</p>
    <p class="tag tag-one svelte-1lqqj55">&lt;/body&gt;</p></span>

  <div class="container-map svelte-1lqqj55"><iframe title="map" src="https://snazzymaps.com/embed/491438" width="100%" height="100%" style="border:none;"></iframe>
    <div class="fill_alt svelte-1lqqj55"></div></div>
</main>`;
});
export {
  Contact as C
