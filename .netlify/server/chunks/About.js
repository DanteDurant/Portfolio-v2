...
const css$1 = {
  code: ".tagcloud.svelte-dxah47{color:var(--pri);font-size:2rem;font-weight:400}@media(min-width: 2560px){.tagcloud.svelte-dxah47{font-size:2.5rem}}",
  map: null
};
const TagCloud_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `<div class="content tagcloud svelte-dxah47"></div>`;
});
