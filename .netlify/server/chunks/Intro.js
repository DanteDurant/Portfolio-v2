...
const css = {
  code: ".main.svelte-xls76j.svelte-xls76j{width:100%;margin:0}.aside-back.svelte-xls76j.svelte-xls76j{min-width:13rem;height:100vh}.container-text.svelte-xls76j.svelte-xls76j{width:100%;display:flex;flex-direction:column;align-self:center;padding-left:6rem}.down.svelte-xls76j.svelte-xls76j{width:3rem;display:flex;flex-direction:column;justify-content:flex-end;align-items:flex-end;z-index:0}.down.svelte-xls76j span.svelte-xls76j{writing-mode:vertical-lr;font-size:1.4rem;color:white;animation:moveUpDown 1s ease-in-out infinite}.down.svelte-xls76j div.svelte-xls76j{padding:0.7rem 0.5rem 2rem 0}.tag-one.svelte-xls76j.svelte-xls76j{position:absolute;left:15rem;top:1rem}.tag-two.svelte-xls76j.svelte-xls76j{position:absolute;left:17rem;top:4rem}.sub.svelte-xls76j.svelte-xls76j{opacity:0}.sub.svelte-xls76j.svelte-xls76j.fadeIn{opacity:1}.sub-head.svelte-xls76j.svelte-xls76j{font-size:1.6rem;letter-spacing:4px;color:var(--text-alt)}.button-con.svelte-xls76j.svelte-xls76j{opacity:0}.button-con.svelte-xls76j.svelte-xls76j.fadeIn{opacity:1}.fadeIn.svelte-xls76j.svelte-xls76j{animation:fadeIn 0.5s ease-in-out forwards}.slideInFromBottomText.svelte-xls76j.svelte-xls76j{animation:slideInFromBottomText 0.5s ease-in-out forwards}",
  map: null
};
const Intro = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<main id="Home" class="main intro svelte-xls76j"><span class="aside-back svelte-xls76j"></span>
  <div class="down svelte-xls76j"><span class="svelte-xls76j">scroll down</span>
    <div class="svelte-xls76j">${validate_component(ArrowDown, "ArrowDown").$$render($$result, {}, {}, {})}</div></div>
  <p class="tag tag-one svelte-xls76j">&lt;/html&gt;</p>
  <p class="tag tag-two svelte-xls76j">&lt;body&gt;</p>
  <section class="container-text svelte-xls76j"><div class="head"><p class="tag" style="margin: 0 0 -1rem -1rem">&lt;h1&gt;</p>
    ...
    " "
        ...
        <p class="sub-head svelte-xls76j">Front End Developer / Designer</p>
        <p class="tag" style="margin: 0 0 2.5rem -1rem;">&lt;p/&gt;</p></div>
      <div class="${[
    "button-con svelte-xls76j",
    " "
