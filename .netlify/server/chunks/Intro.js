...
const global = ':root{--pri: #08fdd8;--sec: #fd2055;--bg: #1d1d1d;--bg-alt: #181818;--bg-form: #3c3c3c;--text: #d9d9d9;--text-alt: #8d8d8d;--tag: #515151}@font-face{font-family:coolvetica;src:url(/_app/immutable/assets/coolvetica-rg.ba89c675.woff2) format("woff2")}.main{scroll-snap-align:start;scroll-snap-stop:always;display:flex;width:calc(100vw - 20.5rem);margin-left:20.5rem;height:100vh}.container{width:100%;height:min-content;display:flex;flex-direction:column;position:relative;align-self:center}.tag{color:var(--tag);font-size:1.8rem;font-style:italic;font-family:La Belle Aurore}.tag-one_top{position:absolute;left:15rem;top:1rem}.tag-two_top{position:absolute;left:17rem;top:4rem}.head{margin:-1.5rem 0 -1rem;color:var(--pri);width:max-content;z-index:0}.head_alt{position:relative;color:var(--text);font-size:1.6rem;line-height:1.5;z-index:1}.center-parent{display:flex;justify-content:center;align-items:center}.center-child{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.column{display:flex;flex-direction:column}html{font-size:62.5%;scroll-behavior:smooth}.snap-scroll{scroll-snap-type:y mandatory;-webkit-overflow-scrolling:touch;overflow-y:scroll}p{margin:0}a{text-decoration:none;color:var(--pri);font-size:1.6rem}body{font-family:Open Sans,sans-serif}h1{font-family:coolvetica,sans-serif}menu{margin-block-start:0em;margin-block-end:0em;margin-inline-start:0px;margin-inline-end:0px;padding-inline-start:0px}body{background-color:#1d1d1d;margin-block-start:0em;margin-block-end:0em;margin-inline-start:0rem;margin-inline-end:0px;padding-inline-start:0px}@media (max-width: 1000px){html{font-size:27.3%}}@media (max-width: 600px){.tendrils,.aside-back{display:none}aside{height:16rem!important;width:100%!important}.main-menu{height:100%!important;width:100%!important;display:flex;flex-direction:row}.main-menu_top{width:26rem!important;height:100%!important;display:flex;flex-direction:row}.main-menu_top .logo{margin-left:2.8rem}.main-menu_top span{display:flex;flex-direction:column;width:100%;align-items:center}.main-menu_top span a{margin:0;overflow:hidden;width:12.7rem;padding-right:5rem}.main-menu_top span a .name{font-family:coolvetica;font-weight:400!important;font-size:8rem!important;line-height:6.5rem!important;margin-left:-1rem}.main-menu_top span .job{font-size:2rem!important;line-height:1.5rem;margin-bottom:-1.2rem;margin-right:-2rem}.main-menu_nav{display:grid;grid-template-columns:auto auto;grid-template-rows:auto auto;gap:.7rem;height:100%;width:1fr!important;justify-content:center;align-items:center;border-top:none!important;margin-top:3rem}.main-menu_nav a{width:12rem;height:4rem;line-height:4rem!important;font-size:2rem;border:1px solid #282828}.main-menu .socials{height:13rem!important;align-items:center;justify-content:center!important;gap:3rem;width:1fr!important;margin-right:4rem}.main-menu .socials li{width:3rem!important}.intro{margin-top:13rem}.intro .tag-one{position:absolute;left:1rem!important;top:15rem!important}.intro .tag-two{position:absolute;left:3rem!important;top:19rem!important}.about{display:flex;flex-direction:column;justify-content:center}.about .container{width:100%!important}.about .tagcloud{width:100%;margin-left:-2rem}}@media (min-width: 1000px){html{font-size:27.3%}}@media (min-width: 1000px){html{font-size:57.5%}}@media (min-width: 1400px){html{font-size:62.5%}}@media (min-width: 1800px){html{font-size:65%}}@media (min-width: 2200px){html{font-size:67.7%}}@media (min-width: 2560px){html{font-size:70%}.skills .container{width:40%!important}.tagcloud{font-size:2.5rem}}@media (min-width: 3000px){html{font-size:77.5%}}@media (min-width: 3400px){html{font-size:87.5%}}@media (min-width: 3840px){html{font-size:97.5%}}\n';
...
const css = {
  code: ".main.svelte-xee2ur.svelte-xee2ur{width:100%;margin:0}.aside-back.svelte-xee2ur.svelte-xee2ur{width:13rem;height:100vh}.container-text.svelte-xee2ur.svelte-xee2ur{width:100%;display:flex;flex-direction:column;align-self:center;margin-left:5rem}.down.svelte-xee2ur.svelte-xee2ur{width:4rem;display:flex;flex-direction:column;justify-content:flex-end;align-items:flex-end;z-index:0}.down.svelte-xee2ur span.svelte-xee2ur{writing-mode:vertical-lr;font-size:1.4rem;color:white;animation:moveUpDown 1s ease-in-out infinite}.down.svelte-xee2ur div.svelte-xee2ur{padding:0.7rem 0.5rem 2rem 0}.tag-one.svelte-xee2ur.svelte-xee2ur{position:absolute;left:15rem;top:1rem}.tag-two.svelte-xee2ur.svelte-xee2ur{position:absolute;left:17rem;top:4rem}.sub.svelte-xee2ur.svelte-xee2ur{opacity:0}.sub.svelte-xee2ur.svelte-xee2ur.fadeIn{opacity:1}.sub-head.svelte-xee2ur.svelte-xee2ur{font-size:1.6rem;letter-spacing:4px;color:var(--text-alt)}.button-con.svelte-xee2ur.svelte-xee2ur{opacity:0}.button-con.svelte-xee2ur.svelte-xee2ur.fadeIn{opacity:1}.fadeIn.svelte-xee2ur.svelte-xee2ur{animation:fadeIn 0.5s ease-in-out forwards}.slideInFromBottomText.svelte-xee2ur.svelte-xee2ur{animation:slideInFromBottomText 0.5s ease-in-out forwards}",
  map: null
};
const Intro = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<main id="Home" class="main intro svelte-xee2ur"><span class="aside-back svelte-xee2ur"></span>
  <div class="down svelte-xee2ur"><span class="svelte-xee2ur">scroll down</span>
    <div class="svelte-xee2ur">${validate_component(ArrowDown, "ArrowDown").$$render($$result, {}, {}, {})}</div></div>
  <p class="tag tag-one svelte-xee2ur">&lt;/html&gt;</p>
  <p class="tag tag-two svelte-xee2ur">&lt;body&gt;</p>
  <section class="container-text svelte-xee2ur"><div class="head"><p class="tag" style="margin: 0 0 -1rem -1rem">&lt;h1&gt;</p>
    ...
    " "
        ...
        <p class="sub-head svelte-xee2ur">Front End Developer / Designer</p>
        <p class="tag" style="margin: 0 0 2.5rem -1rem;">&lt;p/&gt;</p></div>
      <div class="${[
    "button-con svelte-xee2ur",
    " "
