...
const css = {
  code: ".container-text.svelte-14pk9b9.svelte-14pk9b9{width:100%;display:flex;flex-direction:column;align-self:center;padding-left:6rem}.down.svelte-14pk9b9.svelte-14pk9b9{width:3rem;display:flex;flex-direction:column;justify-content:flex-end;align-items:flex-end;z-index:0}.down.svelte-14pk9b9 span.svelte-14pk9b9{writing-mode:vertical-lr;font-size:1.4rem;color:white;animation:moveUpDown 1s ease-in-out infinite}.down.svelte-14pk9b9 div.svelte-14pk9b9{padding:0.7rem 0.5rem 2rem 0}.tag-one.svelte-14pk9b9.svelte-14pk9b9{position:absolute;left:15rem;top:1rem}.tag-two.svelte-14pk9b9.svelte-14pk9b9{position:absolute;left:17rem;top:4rem}.sub.svelte-14pk9b9.svelte-14pk9b9{opacity:0}.sub.svelte-14pk9b9.svelte-14pk9b9.fadeIn{opacity:1}.sub-head.svelte-14pk9b9.svelte-14pk9b9{font-size:1.6rem;letter-spacing:4px;color:var(--text-alt)}.button-con.svelte-14pk9b9.svelte-14pk9b9{opacity:0}.button-con.svelte-14pk9b9.svelte-14pk9b9.fadeIn{opacity:1}.fadeIn.svelte-14pk9b9.svelte-14pk9b9{animation:fadeIn 0.5s ease-in-out forwards}.slideInFromBottomText.svelte-14pk9b9.svelte-14pk9b9{animation:slideInFromBottomText 0.5s ease-in-out forwards}",
  map: null
};
const Intro = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <div class="down svelte-14pk9b9"><span class="svelte-14pk9b9">scroll down</span>
    <div class="svelte-14pk9b9">${validate_component(ArrowDown, "ArrowDown").$$render($$result, {}, {}, {})}</div></div>
  <p class="tag tag-one svelte-14pk9b9">&lt;/html&gt;</p>
  <p class="tag tag-two svelte-14pk9b9">&lt;body&gt;</p>
  <section class="container-text svelte-14pk9b9"><div class="head"><p class="tag" style="margin: 0 0 -1rem -1rem">&lt;h1&gt;</p>
    ...
    " "
        ...
        <p class="sub-head svelte-14pk9b9">Front End Developer / Designer</p>
        <p class="tag" style="margin: 0 0 2.5rem -1rem;">&lt;p/&gt;</p></div>
      <div class="${[
    "button-con svelte-14pk9b9",
    " "
