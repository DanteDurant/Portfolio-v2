import { c as create_ssr_component, v as validate_component, a as subscribe, e as escape, b as add_attribute } from "../../chunks/index2.js";
...
const Tendrils = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<canvas id="canvas" style="top: 0; left: 0; position: fixed; " class="${escape($modalState ? "hide" : "show", true) + " tendrils svelte-mrrokt"}"${add_attribute("this", canvas, 0)}></canvas>`;
});
